package com.ohyoung.quartz.util;

import com.google.common.collect.ImmutableMap;
import com.ohyoung.exception.OperateFailedException;
...
public class QuartzUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, QuartzTask quartzTask){
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "定时任务类路径出错：请输入类的绝对路径"));
        } catch (SchedulerException e) {
            log.error("create task error: {}", e.toString());
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "创建定时任务出错"));
        }
    }
    ...
    public static void pauseScheduleJob(Scheduler scheduler, String jobName){
        ...
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "暂停定时任务出错"));
        }
    }
    ...
    public static void resumeScheduleJob(Scheduler scheduler, String jobName) {
        ...
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "恢复定时任务出错"));
        }
    }
    ...
    public static void runOnce(Scheduler scheduler, String jobName){
        ...
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "立即运行定时任务出错"));
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, QuartzTask quartzTask)  {
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "更新定时任务出错"));
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, String jobName) {
        ...
        try {
            ...
            throw new OperateFailedException(ImmutableMap.of("errorMessage", "删除定时任务出错"));
        }
    }
