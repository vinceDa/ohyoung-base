...
import com.ohyoung.system.repository.JobRepository;
...
public class JobServiceImpl implements JobService {
    ...
    public JobDTO insert(JobDTO jobDTO) {
        ...
        if (byName != null) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "岗位名已存在"));
        }
    ...
    public void delete(Long id) {
        if (!jobRepository.existsById(id)) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "请选择岗位删除"));
        }
    ...
    public JobDTO update(JobDTO jobDTO) {
        ...
        if (!byId.isPresent()) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "请选择岗位编辑"));
        }
