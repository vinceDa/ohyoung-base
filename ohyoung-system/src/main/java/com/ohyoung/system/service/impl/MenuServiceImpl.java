...
import com.ohyoung.system.repository.MenuRepository;
...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuDTO insert(MenuDTO menuDTO) {
        ...
        if (byName != null) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "菜单名已存在"));
        }
        ...
        if (parentId != null && !this.existsById(parentId)) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "未知的父级菜单"));
        }
    ...
    public void delete(Long id) {
        if (!this.existsById(id)) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "请选择菜单删除"));
        }
        // 删除role_menu的绑定关系
    ...
    public MenuDTO update(MenuDTO menuDTO) {
        ...
        if (!byId.isPresent()) {
            ...
            throw new RequestValidationFailedException(ImmutableMap.of("errorMessage", "请选择菜单编辑"));
        }
        Long parentId = menuDTO.getParentId();
        if (parentId != null &&  !this.existsById(parentId)) {
