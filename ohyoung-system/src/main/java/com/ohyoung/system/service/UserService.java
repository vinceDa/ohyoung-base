package com.ohyoung.system.service;
...
public interface UserService {
     ...
     * @return 符合条件的用户信息集合
     */
    Page<UserVO> listPageable(Pageable pageable);
     ...
     * @return 符合条件的用户信息集合
     */
    Page<UserVO> listPageable(Specification<UserQueryCriteria> specification, Pageable pageable);
