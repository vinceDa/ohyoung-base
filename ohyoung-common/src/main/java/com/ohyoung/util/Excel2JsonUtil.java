...
public class Excel2JsonUtil {
     ...
     */
    private static String appId = "ONEX71632FB031912";
    /**
     *  操作人
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        String filePath = "D:\\Download\\WeChat\\WeChat Files\\wxid_a1q40wsxf87c22\\FileStorage\\File\\2020-07\\贵金属接口文档 -.xlsx";
...
//                }
    ...
    private static void getParams(Workbook wb, Sheet sheet, JSONObject params, JSONObject models) {
        ...
        String operationType = getOperationType(wb, sheet.getSheetName());
...
//        systemNameJson.put("id", sysId);
    ...
    private static JSONObject getApisJson(Workbook wb, String sheetName) {
        String operationType = getOperationType(wb, sheetName);
...
//        migrateRuleJson.put("sysId", -1);
    ...
    private static JSONObject getRefModel(boolean isResponseParam, Sheet sheet, int startRowNum, int endRowNum,
        ...
        while (startRowNum <= endRowNum) {
            ...
            if (isSubParam) {
                ...
                if ("BigDecimal".equals(stringCellValue)) {
                    stringCellValue = "float";
                }
                singleItem.put("type", stringCellValue);
            }
     ...
     * @return 接口sheet的接口地址
     */
    private static String getOperationType(Workbook wb, String sheetName) {
